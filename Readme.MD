...
by name; an object at a given oop can be expanded, so that object pointers can be followed. 

Here is a screenshot:

![Overview](http://software.rochus-keller.info/smalltalk80_image_viewer_0.3.png)
